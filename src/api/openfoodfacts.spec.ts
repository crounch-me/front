...
describe('OpenFoodFacts', () => {
  ...
  it('Should call openfoodfacts endpoint with name search parameters.', () => {
    ...
    expect(axios.get).toHaveBeenCalledWith('https://fr.openfoodfacts.org/cgi/search.pl?action=process&tagtype_0=categories&tag_contains_0=contains&tag_0=Saucisse&json=true');
  });
});
